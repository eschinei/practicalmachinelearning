...
Just for curiosity I inspect the frequency of each type of classe:
```{r freq}
...
Now we are ready to subset out data for cross validation:
```{r crossval}
# Data Partition
...
# Cross Validation
As we can see RF provides the highest accuracy compared to the other three models with 99.71%, hence the expected out-of-sample error is about 0.0029, or 0.29% so I chose it for cross validation:
