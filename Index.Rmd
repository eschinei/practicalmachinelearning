...
# Cross Validation
As we can see RF provides the highest accuracy compared to the other two models with 99.59%, hence the expected out-of-sample error is about 0.0041, or 0.41%, so RF is the best model for our data and I use it for cross validation:
